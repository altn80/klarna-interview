...
import com.klarna.risk.decision.domain.CreditHistoryRepository;
...
public class CreditDecisionServiceV1 {
     ...
     *
     * @param creditRequestV1 credit request with the amount and the customer's
     * details
     * @return the decision
     */
    @POST
    ...
    public CreditRequestDecisionV1 handleCreditRequestV1(CreditRequestV1 creditRequestV1) {
        ...
        creditHistoryRepository.persistTransaction(customerDebt.getCustomerEmail(), creditDecision, creditRequestV1.getPurchaseAmount());
